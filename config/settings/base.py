...
from config.settings.projects import *
from config.settings.product import *
from config.settings.sales import *
...
TEMPLATES = [
    {
        ...
        'DIRS': [
                ...
                os.path.join(BASE_DIR, 'templates', 'immoshopy'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Additional locations of static files (source directories for development)
STATICFILES_DIRS = [
