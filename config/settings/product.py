...
class ProductStatus(models.TextChoices):
    ...
    RESERVED = 'RSV', _('Reserved')
    SOLD = 'SLD', _('Sold')
    PENDING = 'PND', _('Pending')
    UNAVAILABLE = 'UNV', _('Unavailable')
    COMING_SOON = 'CMS', _('Coming Soon')
    UNDER_CONSTRUCTION = 'UCN', _('Under Construction')
    MAINTENANCE = 'MNT', _('Under Maintenance')
    DISCONTINUED = 'DSC', _('Discontinued')
    RENTED = 'RNT', _('Rented')  # Spécifique à l'immobilier
