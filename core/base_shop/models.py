...
class BaseCart(PolymorphicModel, metaclass=deferred.PolymorphicForeignKeyBuilder):
    """
...
class BaseCartItem(PolymorphicModel, metaclass=deferred.PolymorphicForeignKeyBuilder):
    """
    This is a holder for the quantity of items in the cart and, obviously, a
    pointer to the actual Product being purchased
    """
    cart = deferred.ForeignKey(BaseCart, on_delete=models.CASCADE, related_name='items',)
